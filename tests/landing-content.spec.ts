...
test.describe('Landing page content', () => {
  test('hero video block displays the video and lists all benefits', async ({ landing }) => {
  ...
  test('renders all primary content sections and copy', async ({ landing }) => {
  ...
  test('product gallery renders all slides', async ({ landing }) => {
  ...
  test('customer reviews — "Show more" reveals the remaining reviews', async ({ landing }) => {
